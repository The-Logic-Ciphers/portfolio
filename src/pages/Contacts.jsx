  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div
          className="py-24 px-10 md:order-1"
        ...
        >
          ...
          <h2
            className="mb-10 text-base font-light leading-7"
            style={{ color: "#606060" }}
          >
          ...
          <div className="flex mb-9">
            ...
            <div className="">
              ...
              <p
                className="text-sm font-light leading-6 flex items-center"
                style={{ color: "#606060" }}
              >
      ...
      <div className="container pt-36 mb-32">
        <div>
          <span
            className="text-5xl font-black flex md:justify-center justify-start"
            style={{ color: "#363636", lineHeight: "42px" }}
          >
            JOIN OUR TEAM
          </span>
          <p
            className="text-2xl font-light leading-7 flex md:justify-center justify-start"
            style={{ color: "#363636 " }}
          >
            Apply for a job
          </p>
        ...
        <div className="md:mx-80 mx-10 mt-24 ">
          <form>
              ...
              <div className="">
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  <div className="sm:col-span-3 col-span-7">
                    ...
                    >
                      Name
                      <AiOutlineCheckCircle className="ms-2 mt-1 text-blue-600" />
                    </label>
                    <div className="mt-2">
                      <input
                        type="text"
                  ...
                  <div className="col-span-7">
                    ...
                    <div className="mt-2">
                      <select
                        ...
                        className="block w-full rounded-full border-0  py-2.5 px-5 text-gray-500  placeholder:text-gray-400 ring-gray-300 ring-1 focus:ring-1  focus:ring-gray-300 focus:border-gray-300 sm:text-sm sm:leading-6 focus:outline-none "
                      >
                        <option value="Designer" className="cursor-pointer">
                          Designer
                        </option>
                        <option value="Photographer" className="cursor-pointer">
                          Photographer
                        </option>
                        <option value="Developer" className="cursor-pointer ">
                          Developer
                        </option>
                  ...
                  <div class="col-span-7">
                    <label
                      for="about"
                      class="text-sm font-bold leading-6 text-gray-900 flex"
                    >
                      {" "}
                      Message{" "}
                      <AiOutlineCheckCircle className="ms-2 mt-1 text-blue-600" />
                    ...
                    <div class="mt-2">
                      <textarea
                        ...
                        name="about"
                        rows="3"
                        class="block w-full rounded-xl border-0  py-2.5 px-5 text-gray-500  placeholder:text-gray-400 ring-gray-300 ring-1 focus:ring-1  focus:ring-gray-300 focus:border-gray-300 sm:text-sm sm:leading-6 focus:outline-none h-44"
                      ></textarea>
                    </div>
                  </div>
                </div>
            ...
            <div className="mt-6 flex items-center">
              <Button
                type="submit"
                className="rounded-full bg-indigo-600 px-8 py-4 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 outline-none"
              >
                Submit
              </Button>
            </div>
